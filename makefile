...
build:
	...
	CGO_ENABLED=0 GOOS=windows GOARCH=arm64       go build -o build/score-windows-arm64.exe score.go
	...
	CGO_ENABLED=0 GOOS=android GOARCH=arm64       go build -o build/score-android-arm64      score.go